...
if __name__ == '__main__':
    ...
    for folds in range(5):
        ...
        test_oof_means(
            path='../../oof/bk_oof/Multi_Head_ResNext_seed_1111_aug/',
            name1='test_7_folds_1',
            name2='test_aug_7_folds_1')
        test_oof_means(
            path='../../oof/bk_oof/Multi_Head_ResNext_seed_1111_aug/',
        ...
        test_oof_means(
            path='../../oof/bk_oof/Multi_Head_ResNext_seed_1111_aug/',
            name1='test_5_folds_3',
            name2='test_aug_5_folds_3')
        test_oof_means(
            path='../../oof/bk_oof/Multi_Head_ResNext_seed_1111_aug/',
        ...
        test_oof_means(
            path='../../oof/bk_oof/Multi_Head_ResNext_seed_1111_aug/',
            name1='test_4_folds_0',
            name2='test_aug_4_folds_0')
