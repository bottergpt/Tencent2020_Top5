...
parser.add_argument('--seed', type=int, default=712520)
parser.add_argument('--cvseed', type=int, default=520712)
...
ZQ_EMB_LST = [
    ...
    "AZ_cbow_CONCAT_time_diff_60WINDOW_10EPOCH", "AZ_timeemb"
]
...
YOUR_MARKER = f"2020_DataAug_SPLIT_LSTM_SEED{SEED}"
...
if __name__ == "__main__":
    ...
    for count, (train_index, test_index) in enumerate(folds):
		...
		with distribution.scope():
			model = create_model_AZ_split_lstm(rnn_unit=LSTM_UNIT, concated_id_emb_dict=CONCATED_ID_EMB_DICT)
